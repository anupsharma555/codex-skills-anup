---
name: codex-mature-repo-refinement
...
- an issue is real but too broad for this pass; use `codex-repo-diagnostic-backlog-review` instead

Use `codex-implementation-strategy` for compatibility-sensitive planning, `codex-code-review-and-quality` for review findings, `codex-test-quality-and-coverage` for meaningful test additions, and `codex-repo-change-verification` before claiming completion.
