---
name: codex-general-mature-repo-refinement
...
- an issue is real but too broad for this pass; use `codex-general-repo-diagnostic-backlog-review` instead

Use `codex-general-implementation-strategy` for compatibility-sensitive planning, `codex-general-code-review-and-quality` for review findings, `codex-general-test-quality-and-coverage` for meaningful test additions, and `codex-general-repo-change-verification` before claiming completion.
