---
name: codex-general-implementation-strategy
...
If acceptance criteria are missing or subjective, use `codex-general-requirements-acceptance-clarifier` before editing. If the change is tiny and the answers are obvious from the code, keep the strategy implicit and proceed.
